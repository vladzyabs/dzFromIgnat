...
test('array of people should be sorted up', () => {
    ...
    expect(sortState.people.length).toBe(initialState.people.length)
    expect(sortState.people[0].name).toBe('Andrey')
    expect(sortState.people[1].name).toBe('Andrey')
...
test('array of people should be sorted down', () => {
    ...
    expect(sortState.people[4].name).toBe('Andrey')
